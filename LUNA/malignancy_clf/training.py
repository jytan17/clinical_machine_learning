...
class ClassificationTrainingApp:
    ...
    def initModel(self):
        model_cls = getattr(malginancy_clf.model, self.cli_args.model)
        model = model_cls()
    ...
    def initTrainDl(self):
        ds_cls = getattr(malginancy_clf.dsets, self.cli_args.dataset)
    ...
    def computeBatchLoss(self, batch_ndx, batch_tup, batch_size, metrics_g,
        ...
        if augment:
            input_g = malginancy_clf.model.augment3d(input_g)
