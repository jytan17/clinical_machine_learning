...
from nodule_seg.dsets import Luna2dSegmentationDataset
from .dsets import LunaDataset, getCt, getCandidateInfoDict, getCandidateInfoList, CandidateInfoTuple
from nodule_seg.model import UNetWrapper

import malginancy_clf.model
...
class NoduleAnalysisApp:
    ...
    def initModelPath(self, type_str):
        local_path = os.path.join(
            ...
            'part2',
            'models',
            'nodule_seg',#self.cli_args.tb_prefix,
    ...
    def initModels(self):
        ...
        model_cls = getattr(malginancy_clf.model, self.cli_args.cls_model)
        cls_model = model_cls()
        ...
        if self.cli_args.malignancy_path:
            model_cls = getattr(malginancy_clf.model, self.cli_args.malignancy_model)
